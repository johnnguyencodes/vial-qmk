...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_adam_thompson(
        ...
        KC_GRV,  _______, _______, _______, KC_LGUI, _______, KC_ENT, _______,         _______, KC_SPC,   _______, KC_RGUI, _______, KC_LBRC, KC_RBRC, _______
    ),

    [1] = LAYOUT_adam_thompson(
